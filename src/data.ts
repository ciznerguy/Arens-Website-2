...
export const gradesData: GradeLevel[] = [
  {
    grade: 'ז',
    coordinator: "רועי רותם, ענבל ממן, אורית הדר לבהר",
    leadership: [
  ...
  {
    grade: 'ח',
    coordinator: "איריס שחמון, שני מנור, רינת שטקל",
    leadership: [
    ...
    classes: [
      ...
      { id: 'h2', name: "ח' 2", homeroomTeacher: 'ורד לחיאני', room: 'קומה 2, חדר 202' },
      { id: 'h3', name: "ח' 3", homeroomTeacher: 'איריס שחמון', room: 'קומה 2, חדר 203' },
      { id: 'h4', name: "ח' 4", homeroomTeacher: 'אילן זק', room: 'קומה 2, חדר 204' },
      { id: 'h5', name: "ח' 5", homeroomTeacher: 'שני מנור זמר טוב', room: 'קומה 2, חדר 205' },
      { id: 'h6', name: "ח' 6 - כיתה אולימפית", homeroomTeacher: 'מרים קורצ׳נוי', room: 'קומה 2, חדר 206', specialty: 'כיתה אולימפית למצוינות' },
      { id: 'h7', name: "ח' 7", homeroomTeacher: 'שרית כץ', room: 'קומה 2, חדר 207' },
      { id: 'h8', name: "ח' 8", homeroomTeacher: 'רינת שטקל אקשטיין', room: 'קומה 2, חדר 208' },
      { id: 'h9', name: "ח' 9 - כיתה תקשורתית", homeroomTeacher: 'עדי שטיין', room: 'קומה 2, חדר 209', specialty: 'כיתה תקשורתית' },
      { id: 'h10', name: "ח' 10 - כיתה תקשורתית", homeroomTeacher: 'הילה דוד', room: 'קומה 2, חדר 210', specialty: 'כיתה תקשורתית' }
    ]
  },
  {
    grade: 'ט',
    coordinator: "נדב גורן, ענבל מדויל, שילת בדש, סמדר קקון",
    leadership: [
